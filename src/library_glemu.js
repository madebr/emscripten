...
{{{ (updateExport = () => '', '') }}}
  ...
  glTexGeni: () => { throw 'glTexGeni: TODO' },
  glTexGenfv: () => { throw 'glTexGenfv: TODO' },
  glTexEnvi: () => warnOnce('glTexEnvi: TODO'),
  glTexEnvf: () => warnOnce('glTexEnvf: TODO'),
  glTexEnvfv: () => warnOnce('glTexEnvfv: TODO'),
  ...
  glTexImage1D: () => { throw 'glTexImage1D: TODO' },
  glTexCoord3f: () => { throw 'glTexCoord3f: TODO' },
  glGetTexLevelParameteriv: () => { throw 'glGetTexLevelParameteriv: TODO' },
