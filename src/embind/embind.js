...
//    }
  ...
  _embind_register_class_property: (classType,
    ...
    whenDependentTypesAreResolved([], [classType], function(classType) {
      ...
      var desc = {
        get: () => throwUnboundTypeError(`Cannot access ${humanName} due to unbound types`, [getterReturnType, setterArgumentType]),
        enumerable: true,
        configurable: true
      };
      if (setter) {
  ...
  _embind_register_class_class_property: (rawClassType,
    ...
    whenDependentTypesAreResolved([], [rawClassType], function(classType) {
      ...
      var humanName = `${classType.name}.${fieldName}`;
      var desc = {
        get: () => throwUnboundTypeError(`Cannot access ${humanName} due to unbound types`, [rawFieldType]),
        enumerable: true,
        configurable: true
      };
      if (setter) {
      ...
      whenDependentTypesAreResolved([], [rawFieldType], function(fieldType) {
        ...
        var desc = {
          get: () => fieldType['fromWireType'](getter(rawFieldPtr)),
          enumerable: true
        };
