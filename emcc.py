...
# steps.  In packaged versions (e.g. emsdk) this file does not exist
# and these steps are assumed to have been run already.
if os.path.exists(utils.path_from_root('bootstrap.py')):
  import bootstrap
  bootstrap.check()
